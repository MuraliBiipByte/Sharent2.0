...
let ErrorDomainConnection = "com.biipbyte.Sharent.connection"
let ErrorDomainUser = "com.biipbyte.Sharent.user"
...
class ConnectionManager: NSObject, SBDConnectionDelegate {
    ...
    static public func productlogin(userId: String, completionHandler: ((_ user: SBDUser?, _ error: NSError?) -> Void)?) {
    ...
    private func login(userId: String, completionHandler: ((_ user: SBDUser?, _ error: NSError?) -> Void)?) {
        SBDMain.connect(withUserId: userId) { (user, error) in
            ...
            SBDMain.updateCurrentUserInfo(withNickname: userId, profileUrl: nil, completionHandler: { (error) in
                guard error == nil else {
