...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open var optionCalendarBackgroundColorTodayHighlight = UIColor.black ///
    ...
    open var optionCalendarBackgroundColorPastDatesHighlight = UIColor.black //
    ...
    open var optionCalendarBackgroundColorFutureDatesHighlight = UIColor.black //
    ...
    open var optionClockBackgroundColorAMPMHighlight = UIColor.black ////
    ...
    open var optionClockBackgroundColorHourHighlight = UIColor.black ///
    open var optionClockBackgroundColorHourHighlightNeedle = UIColor.black ///
    ...
    open var optionClockBackgroundColorMinuteHighlight = UIColor.black //////
    open var optionClockBackgroundColorMinuteHighlightNeedle = UIColor.black   //////
    ...
    open var optionButtonFontColorCancel = UIColor.black ///
    open var optionButtonFontColorDone = UIColor.black  //
    open var optionButtonFontColorCancelHighlight = UIColor.black.withAlphaComponent(0.25) ///
    open var optionButtonFontColorDoneHighlight = UIColor.black.withAlphaComponent(0.25) //
    open var optionButtonBackgroundColorCancel = UIColor.clear
    open var optionButtonBackgroundColorDone = UIColor.clear
    
    open var optionTopPanelBackgroundColor = UIColor.black  /////
    ...
    open var optionSelectorPanelBackgroundColor = UIColor.black.withAlphaComponent(0.9) ///
    ...
    fileprivate var tintColor : UIColor! = UIColor.black ///
...
//                if (currentDateTime > rangeDate){
//
//                    let alert = UIAlertController.init(title: "Sharent", message: "Please Select Date above the current date", preferredStyle: .alert)
//
